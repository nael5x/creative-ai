...
export const ui = {
  en: {
    ...
    docFit: "Documented fit", docFitWinner: "Better documented fit for this workflow:", docFitSimilar: "Both tools have a similar documented fit for this workflow", docFitInconclusive: "Inconclusive — evidence coverage differs for this workflow.", docFitInsufficient: "No clear documented-fit advantage from the available evidence",
  ...
  ar: {
    ...
    docFit: "الملاءمة الموثّقة", docFitWinner: "ملاءمة موثّقة أفضل لهذا المسار:", docFitSimilar: "كلتا الأداتين لهما ملاءمة موثّقة مشابهة لهذا المسار", docFitInconclusive: "غير حاسم — تغطية الأدلة مختلفة لهذا المسار.", docFitInsufficient: "لا ميزة ملاءمة موثّقة واضحة من الأدلة المتاحة",
